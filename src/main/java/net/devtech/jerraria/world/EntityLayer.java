...
public interface EntityLayer {
	 ...
	 */
	Stream<Entity> getEntitiesEnclosed(EntitySearchType type, double fromX, double fromY, double toX, double toY);
	 ...
	 */
	default Stream<Entity> getEntitiesIntersect(EntitySearchType type, double fromX, double fromY, double toX, double toY, int range) {
	...
	default <T> Stream<T> getEntities(Class<T> class_, EntitySearchType type, double fromX, double fromY, double toX, double toY) {
