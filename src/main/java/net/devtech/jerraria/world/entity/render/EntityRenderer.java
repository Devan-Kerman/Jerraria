...
public interface EntityRenderer {
	...
	void renderEntity(Entity entity, Mat2x3f matrix, int windowFromX, int windowFromY, int windowToX, int windowToY);

	class CombinedEntityRenderer implements EntityRenderer {
		final List<EntityRenderer> renderers = new ArrayList<>();

		@Override
		public void renderEntity(Entity entity, Mat2x3f matrix, int windowFromX, int windowFromY, int windowToX, int windowToY) {
