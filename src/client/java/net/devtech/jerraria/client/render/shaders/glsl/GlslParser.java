package net.devtech.jerraria.client.render.shaders.glsl;

import static net.devtech.jerraria.client.render.shaders.glsl.GlslLang.KEYWORDS;
import static net.devtech.jerraria.client.render.shaders.glsl.GlslLang.PREPROCESSOR_WITH_CONDITION;
import static java.util.Objects.requireNonNull;
import net.devtech.jerraria.client.render.shaders.glsl.ast.*;
import net.devtech.jerraria.client.render.shaders.glsl.ast.branching.ForAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.branching.IfAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.branching.condition.*;
import net.devtech.jerraria.client.render.shaders.glsl.ast.declaration.ExternalFieldDeclarationAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.declaration.ExternalFieldDeclarationAstNode.ExternalFieldType;
...
import net.devtech.jerraria.client.render.shaders.glsl.ast.declaration.LocalVarDeclarationAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.declaration.MethodDeclarationAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.declaration.StructDeclarationAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.declaration.VarDeclarationAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.preprocessor.*;
import net.devtech.jerraria.client.render.shaders.glsl.ast.util.AstUtils;
import net.devtech.jerraria.client.render.shaders.glsl.ast.util.BiPredicate;
import net.devtech.jerraria.client.render.shaders.glsl.ast.value.DefineValueAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.value.ExtensionStatusValueAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.value.StringValueAstNode;
import net.devtech.jerraria.client.render.shaders.glsl.ast.value.ValueAstNode;
...
public class GlslParser {
     ...
     */
    private ExternalFieldDeclarationAstNode parseExternalFieldDeclaration(final Token keywordToken,
                                                                          final char[] content) {
	...
	private void parseStructDeclaration(Token structKeywordToken, char[] content) {
