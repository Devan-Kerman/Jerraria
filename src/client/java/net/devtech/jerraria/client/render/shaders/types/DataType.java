package net.devtech.jerraria.client.render.shaders.types;
...
public enum DataType {
	...
	NORMALIZED_F8(GL_FLOAT, 1, true, "float"),
	NORMALIZED_F16(GL_FLOAT, 2, true, "float"),
	NORMALIZED_F32(GL_FLOAT, 4, true, "float"),
	...
	DataType(DataType type, int count, String name) {
		this(name, type.normalized, type.byteCount * count, count, type.elementType);
	}
	...
	DataType(String name, boolean normalized, int count, int elementCount, int elementType) {
		this.glslName = name;
