...
public abstract class Color<N extends GlValue<?>> extends AbstractGlValue<N> implements GlValue.Attribute {
	 ...
	 */
	public static <N extends GlValue<?>> Type<RGB<N>> rgb(String name) {
	 ...
	 */
	public static <N extends GlValue<?>> Type<ARGB<N>> argb(String name) {
	 ...
	 */
	public static <N extends GlValue<?>> Type<RGB<N>> rgb(String name, String groupName) {
		return simple(RGB::new, DataType.NORMALIZED_F8_VEC3, name, groupName);
	}

	public static <N extends GlValue<?>> Type<ARGB<N>> argb(String name, String groupName) {
