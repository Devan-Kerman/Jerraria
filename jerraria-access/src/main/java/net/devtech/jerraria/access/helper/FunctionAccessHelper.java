...
import net.devtech.jerraria.access.internal.CompiledFunctionClassValue;
import net.devtech.jerraria.access.internal.FunctionCompiler;
import net.devtech.jerraria.access.provider.GenericProvider;
